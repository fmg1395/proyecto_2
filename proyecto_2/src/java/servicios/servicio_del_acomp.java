 ...
 * @author Kike
 */
@WebServlet(name = "servicio_del_acomp", urlPatterns = {"/servicio_del_acomp"})
@MultipartConfig
public class servicio_del_acomp extends HttpServlet{
      protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean insert = new GestorExtras().deleteExtra(extra.getId());
